...
tokenTestData = {
    ...
    "praktikum" : ["BAI1-PRP1/02", "BTI1-GTP/02", "A-M2-PSP", "BMT5- BUP", 'BAI1-PTP/01', 'BAI2-RMPP/01', 'BAI3-GKAP/01', 'BWI5-WIP3/01'],
    ...
    "vorkurs" : ["Vorkurs PRG"],
    "vorlesung" : ["BAI1-PR1", "BMT5 BU", 'BAI1-PM1', 'BAI2-RMP'],
